      ...
      <div className="relative z-10">
        ...
        {state.success ? (
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Button
              type="submit"
              className="relative overflow-hidden w-full bg-gradient-to-r from-blue-500 to-teal-500 text-white transition-all duration-300 shadow-lg hover:shadow-blue-500/25 hover:shadow-xl hover:scale-[1.02] group btn-gradient-hover btn-pulse"
              disabled={isSubmitting}
            >
