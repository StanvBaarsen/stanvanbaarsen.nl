		...
		<>
			<div className="flex min-h-screen flex-col bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
					...
					<div className="container mx-auto flex h-16 items-center px-4 md:px-6 w-full">
						<div className="mr-4 hidden md:flex">
							<Link href="/" className="mr-6 flex items-center space-x-2 group">
								<span className="bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-xl font-bold text-transparent transition-all duration-300 group-hover:from-blue-700 group-hover:to-blue-500">
									Stan van Baarsen
								</span>
							</Link>
							<nav className="flex items-center space-x-6 text-sm font-medium">
								<Link 
									...
									className={`transition-all duration-300 hover:scale-105 ${
										activeSection === "about" ? "text-blue-500 dark:text-blue-400" : ""
									}`}
								>
									About
								</Link>
								<Link 
									...
									className={`transition-all duration-300 hover:scale-105 ${
										activeSection === "contact" ? "text-blue-500 dark:text-blue-400" : ""
									}`}
								>
									Contact
								</Link>
				...
				<main className="flex-1">
					<section className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-slate-50 dark:from-slate-900 dark:to-blue-950">
						...
						<div className="container mx-auto relative z-10 grid items-center gap-6 px-4 pb-20 pt-16 md:px-6 md:py-8 lg:py-32 w-full">
							<div className="flex flex-col items-center gap-8 md:flex-row md:gap-12">
								<div className="flex flex-col items-center md:items-start">
									{/* <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-blue-100 px-3 py-1 text-sm font-medium text-blue-800 dark:bg-blue-900/50 dark:text-blue-300 animate-fade-in">
								...
								<div className={`flex justify-center md:justify-end md:flex-1 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
									<div className="relative">
										<div className="absolute -inset-6 rounded-full bg-gradient-to-r from-blue-500/30 to-blue-700/30 blur-xl animate-pulse"></div>
										<div className="absolute -inset-4 rounded-full bg-gradient-to-r from-blue-500/20 to-blue-700/20 blur-lg animate-pulse delay-300"></div>
										<Image
											src="/headshot.jpg"
					...
					<section id="about" className="relative py-12 md:py-12 overflow-hidden px-12">
						<div className="absolute inset-0 z-0 opacity-30">
				...
				<button
					...
					className="fixed bottom-6 right-6 z-50 flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-700 text-white shadow-lg transition-all hover:shadow-blue-500/25 hover:scale-110 hover:rotate-3"
