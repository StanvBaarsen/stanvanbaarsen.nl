	...
	return (
		<section id="about" className="relative pb-8 overflow-hidden">
			<div className="container mx-auto relative z-10 px-4 md:px-6 w-full max-w-full">
				...
				<div className="mb-16 flex flex-col items-center text-center animate-fade-in"> {/* Existing title animation is fine */}
				...
				<div className="grid gap-12 md:grid-cols-2 items-center">
					...
					<div ref={textContentRef} data-animation-type="slideInFromLeft" className="opacity-0 order-2 md:order-1 relative"> {/* Removed animate-slide-up */}
						<div className="relative space-y-6 backdrop-blur-lg rounded-xl p-6 border border-white/20 dark:border-white/10 bg-white/50 dark:bg-slate-900/50 shadow-xl"> 
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
								<div ref={educationRef} data-animation-type="slideInFromBottom" className="opacity-0 flex flex-col gap-3 items-center md:items-start group"> {/* Added group */}
									<div className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 transition-transform duration-200 ease-in-out group-hover:scale-110"> {/* Added transition & group-hover scale */}
								...
								<div ref={skillsRef} data-animation-type="slideInFromBottom" className="opacity-0 flex flex-col gap-3 items-center md:items-start delay-200 group"> {/* Added group & Tailwind delay */}
									<div className="flex items-center justify-center w-10 h-10 rounded-full bg-sky-100 dark:bg-sky-900/50 text-sky-600 dark:text-sky-400 transition-transform duration-200 ease-in-out group-hover:scale-110"> {/* Added transition & group-hover scale */}
								...
								<div ref={passionsRef} data-animation-type="slideInFromBottom" className="opacity-0 flex flex-col gap-3 items-center md:items-start delay-300 group"> {/* Added group & Tailwind delay */}
									<div className="flex items-center justify-center w-10 h-10 rounded-full bg-teal-100 dark:bg-teal-900/50 text-teal-600 dark:text-teal-400 transition-transform duration-200 ease-in-out group-hover:scale-110"> {/* Added transition & group-hover scale */}
							...
							<div className="flex justify-center">
								<a 
									...
									className="group inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-sky-500 text-white font-medium shadow-md hover:shadow-xl hover:from-blue-600 hover:to-sky-600 transition-all duration-300 hover:scale-105 transform" /* Added group */
								>
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 transition-transform duration-200 ease-in-out group-hover:translate-x-0.5"> {/* Added transition & group-hover transform */}
					...
					<div ref={imageContentRef} data-animation-type="slideInFromRight" className="opacity-0 order-1 md:order-2 relative flex items-center justify-center p-6"> {/* Removed animate-slide-up */}
